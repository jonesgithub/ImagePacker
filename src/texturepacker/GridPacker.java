...
public class GridPacker implements Packer {
	...
	public Array<Page> pack (Array<Rect> inputRects) {
		...
		System.out.print("duruizhi Packing");
		...
		System.out.println(String.format("pages 's size %d", pageCount));
		return pages;
	}
	...
	private Page packPage (Array<Rect> inputRects, int cellWidth, int cellHeight) {
		...
		System.out.println("start packPack");
...
//					break;
				...
				System.out.println(String.format("rect index %d",i));
				x = 0;
			}
